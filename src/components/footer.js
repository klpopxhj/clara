...
const Footer = () => {
  return (
    ...
    //     <FooterAttribution>
    //       &copy; Copyright {new Date().getFullYear()}, QuantCtrl
    //     </FooterAttribution>
    //   </FooterWrapper>
    // </StyledFooter>
    ...
    //           href="https://www.linkedin.com/company/quantctrl/"
    //         >
    //           QuantCtrl LLP
    //         </a>
    //         <span className="mt-7 md:mt-1">All Rights Reserved</span>
    //       </div>
    //     </div>
    //   </div>
    // </footer>
      ...
      <div className="grid max-w-screen-xl grid-cols-1 mx-auto lg:grid-cols-2">
        <div className="px-4 py-16 border-b border-gray-800 md:border-b-0 md:border-l lg:pl-12 lg:order-last">
          <div className="block lg:hidden">
            <span className="inline-block w-32 h-10 bg-gray-700 rounded-lg" />
          </div>
          <div className="mt-12 space-y-4 lg:mt-0">
            <span className="block w-10 h-1 bg-indigo-500 rounded" />
            <div>
